...
function isCoursAccessible(formationId, coursOrdre) { if (coursOrdre === 1) return true; const prev = getLocalProgressions().find(p => p.formation_id === formationId && parseInt(p.cours_id.split('_c')[1]) === coursOrdre - 1); return prev && prev.quiz_reussi; }
